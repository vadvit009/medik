            ...
            .then((user) => {
                if (user) {
                    function sendMessage(auth) {
                        const gmail = google.gmail({version: 'v1', auth});
                        const raw = makeBody(email, 'medtechnika.te@gmail.com', 'Відновлення паролю', `<a href="https://medtechnika.te.ua/restore/${randomizerPass}">Натисніть для відновлення паролю</a>>`);
